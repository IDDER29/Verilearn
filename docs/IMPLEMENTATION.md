...
|---|--:|---|
| ✅ Done | 130 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 207 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after pre-filled example on-ramps (HOME-02) — 130 Done; remainder is field-polish or deferred-with-justification._
