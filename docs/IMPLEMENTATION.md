...
|---|--:|---|
| ✅ Done | 83 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 254 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the task-type label pass (TASK-01) — 83 Done; remainder is field-polish or deferred-with-justification._
