...
**Test count:** 264 passing across 22 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 59 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 278 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the Notifications read-state pass — 59 Done; remainder is field-polish or deferred-with-justification._
