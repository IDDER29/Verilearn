...
|---|--:|---|
| ✅ Done | 46 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 291 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the My Tasks aggregation pass — 46 Done; remainder is field-polish or deferred-with-justification._
