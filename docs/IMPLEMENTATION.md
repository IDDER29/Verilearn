...
**Test count:** 301 passing across 25 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 117 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 220 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the review-ahead session (REVIEW-11) — 117 Done; remainder is field-polish or deferred-with-justification._
