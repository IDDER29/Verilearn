...
|---|--:|---|
| ✅ Done | 110 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 227 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the reduced-motion + focus-visible pass (A11Y-05) — 110 Done; remainder is field-polish or deferred-with-justification._
