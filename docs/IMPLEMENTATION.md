...
**Test count:** 306 passing across 25 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 124 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 213 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the settings catch-all + plan-aware upsell (SETTINGS-01) — 124 Done; remainder is field-polish or deferred-with-justification._
