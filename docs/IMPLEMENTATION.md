...
|---|--:|---|
| ✅ Done | 100 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 237 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the notifications a11y pass (NOTIF-18) — 100 Done; remainder is field-polish or deferred-with-justification._
