...
|---|--:|---|
| ✅ Done | 95 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 242 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the notification deep-link pass (NOTIF-03) — 95 Done; remainder is field-polish or deferred-with-justification._
