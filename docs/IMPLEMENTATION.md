...
**Test count:** 290 passing across 24 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 98 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 239 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the review eligibility-gating pass (REVIEW-15) — 98 Done; remainder is field-polish or deferred-with-justification._
