...
|---|--:|---|
| ✅ Done | 45 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 292 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the Progress per-topic pass — 45 Done; remainder is field-polish or deferred-with-justification._
