...
|---|--:|---|
| ✅ Done | 63 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 274 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the GAP intake/detail pass — 63 Done; remainder is field-polish or deferred-with-justification._
