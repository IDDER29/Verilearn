...
|---|--:|---|
| ✅ Done | 114 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 223 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the review-gate a11y pass (A11Y-03) — 114 Done; remainder is field-polish or deferred-with-justification._
