...
**Test count:** 277 passing across 24 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 81 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 256 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the server-side create-topic gate pass (VERIFY-02) — 81 Done; remainder is field-polish or deferred-with-justification._
