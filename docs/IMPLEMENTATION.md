...
|---|--:|---|
| ✅ Done | 127 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 210 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after dashboard focus-reconciliation (HOME-19) — 127 Done; remainder is field-polish or deferred-with-justification._
