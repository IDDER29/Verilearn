...
|---|--:|---|
| ✅ Done | 73 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 264 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the DSAR data-export pass (SETTINGS-13) — 73 Done; remainder is field-polish or deferred-with-justification._
