...
|---|--:|---|
| ✅ Done | 123 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 214 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the CSP/security-headers envelope (SEC-19) — 123 Done; remainder is field-polish or deferred-with-justification._
