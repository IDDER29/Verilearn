...
|---|--:|---|
| ✅ Done | 109 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 228 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the creation-flow a11y pass (VERIFY-18) — 109 Done; remainder is field-polish or deferred-with-justification._
