...
|---|--:|---|
| ✅ Done | 129 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 208 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after real dashboard topic search + operators (HOME-06/18) — 129 Done; remainder is field-polish or deferred-with-justification._
