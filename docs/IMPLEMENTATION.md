...
|---|--:|---|
| ✅ Done | 77 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 260 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the gap manual-close pass (GAP-03) — 77 Done; remainder is field-polish or deferred-with-justification._
