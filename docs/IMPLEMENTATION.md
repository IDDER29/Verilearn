...
|---|--:|---|
| ✅ Done | 104 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 233 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the per-section trust panel (LEARN-04) — 104 Done; remainder is field-polish or deferred-with-justification._
