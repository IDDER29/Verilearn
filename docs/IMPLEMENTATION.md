...
**Test count:** 300 passing across 25 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 116 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 221 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after per-learner FSRS tuning (REVIEW-13) — 116 Done; remainder is field-polish or deferred-with-justification._
