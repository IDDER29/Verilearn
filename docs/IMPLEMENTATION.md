...
**Test count:** 271 passing across 23 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 76 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 261 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the review primer pass (REVIEW-01) — 76 Done; remainder is field-polish or deferred-with-justification._
