...
**Test count:** 250 passing across 19 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 43 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 294 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the Lecture claim-detail pass — 43 Done; remainder is field-polish or deferred-with-justification._
