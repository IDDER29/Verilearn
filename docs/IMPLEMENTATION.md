...
|---|--:|---|
| ✅ Done | 96 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 241 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the gap practice-handoff pass (GAP-09) — 96 Done; remainder is field-polish or deferred-with-justification._
