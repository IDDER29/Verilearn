...
|---|--:|---|
| ✅ Done | 82 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 255 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the real pipeline-stage-detail pass (VERIFY-04) — 82 Done; remainder is field-polish or deferred-with-justification._
