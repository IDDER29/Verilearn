...
**Test count:** 304 passing across 25 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 120 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 217 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the in-app offline banner (A11Y-19) — 120 Done; remainder is field-polish or deferred-with-justification._
