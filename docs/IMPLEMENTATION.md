...
|---|--:|---|
| ✅ Done | 75 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 262 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the Lecture real-sections pass (LEARN-01) — 75 Done; remainder is field-polish or deferred-with-justification._
