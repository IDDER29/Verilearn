...
**Test count:** 295 passing across 24 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 111 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 226 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the app-shell landmarks/skip-link pass (A11Y-08) — 111 Done; remainder is field-polish or deferred-with-justification._
