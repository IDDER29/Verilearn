...
|---|--:|---|
| ✅ Done | 105 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 232 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the signal-provenance drill-in (ANALYTICS-02) — 105 Done; remainder is field-polish or deferred-with-justification._
