...
|---|--:|---|
| ✅ Done | 115 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 222 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after reconciling the coverage/gap a11y story (A11Y-07) — 115 Done; remainder is field-polish or deferred-with-justification._
