...
|---|--:|---|
| ✅ Done | 72 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 265 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the SETTINGS reconciliation sweep — 72 Done; remainder is field-polish or deferred-with-justification._
