...
|---|--:|---|
| ✅ Done | 87 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 250 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the dashboard verifying-status pass (HOME-10) — 87 Done; remainder is field-polish or deferred-with-justification._
