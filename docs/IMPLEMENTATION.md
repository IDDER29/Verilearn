...
|---|--:|---|
| ✅ Done | 57 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 280 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the Profile + Auth/Danger reconciliation pass — 57 Done; remainder is field-polish or deferred-with-justification._
