...
|---|--:|---|
| ✅ Done | 126 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 211 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after reconciling the real plan usage meter (SETTINGS-04) — 126 Done; remainder is field-polish or deferred-with-justification._
