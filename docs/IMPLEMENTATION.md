...
|---|--:|---|
| ✅ Done | 125 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 212 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the real retention trend chart (ANALYTICS-05) — 125 Done; remainder is field-polish or deferred-with-justification._
