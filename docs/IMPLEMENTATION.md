...
|---|--:|---|
| ✅ Done | 106 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 231 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the gap-board a11y pass (GAP-16) — 106 Done; remainder is field-polish or deferred-with-justification._
