...
**Test count:** 302 passing across 25 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 118 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 219 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after per-category notification prefs (NOTIF-08) — 118 Done; remainder is field-polish or deferred-with-justification._
