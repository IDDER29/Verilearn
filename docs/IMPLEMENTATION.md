...
|---|--:|---|
| ✅ Done | 85 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 252 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the gated model-answer pass (TASK-06) — 85 Done; remainder is field-polish or deferred-with-justification._
