...
**Test count:** 278 passing across 24 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 84 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 253 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the per-criterion revise-guidance pass (TASK-05) — 84 Done; remainder is field-polish or deferred-with-justification._
