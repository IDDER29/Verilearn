...
**Test count:** 270 passing across 23 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 74 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 263 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the settings-controls accessibility pass (SETTINGS-23) — 74 Done; remainder is field-polish or deferred-with-justification._
