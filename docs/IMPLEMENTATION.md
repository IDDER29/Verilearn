...
|---|--:|---|
| ✅ Done | 64 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 273 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the caught-up state pass (REVIEW-18) — 64 Done; remainder is field-polish or deferred-with-justification._
