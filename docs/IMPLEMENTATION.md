...
|---|--:|---|
| ✅ Done | 90 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 247 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the global conflict-inbox pass (TRUST-06) — 90 Done; remainder is field-polish or deferred-with-justification._
