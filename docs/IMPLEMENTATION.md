...
|---|--:|---|
| ✅ Done | 119 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 218 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after tasks→readiness linkage (TASK-13) — 119 Done; remainder is field-polish or deferred-with-justification._
