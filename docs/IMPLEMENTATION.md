...
**Test count:** 272 passing across 23 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 78 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 259 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the gap triage-filters pass (GAP-12) — 78 Done; remainder is field-polish or deferred-with-justification._
