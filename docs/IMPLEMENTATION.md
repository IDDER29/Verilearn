...
**Test count:** 279 passing across 24 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 86 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 251 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the portfolio-band + plan-meter pass (ANALYTICS-19) — 86 Done; remainder is field-polish or deferred-with-justification._
