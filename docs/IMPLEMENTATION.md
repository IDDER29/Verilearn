...
|---|--:|---|
| ✅ Done | 113 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 224 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the tests-hub data wiring (TEST-08) — 113 Done; remainder is field-polish or deferred-with-justification._
