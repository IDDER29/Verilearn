...
**Test count:** 273 passing across 23 files · build green.

## Roadmap accounting (462 stories — 100% accounted for)

| Disposition | Count | Meaning |
|---|--:|---|
| ✅ Done | 79 | core behavior implemented + tested, or wired to real data |
| 🟡 Partial | 258 | engine/logic done with headline UI wired, or faithful screen awaiting full binding |
...
_Last updated: after the gap-heat + readiness-link pass (GAP-11) — 79 Done; remainder is field-polish or deferred-with-justification._
