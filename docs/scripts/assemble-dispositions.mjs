...
const ROWS = [
  ["AUTH", "Authentication, Onboarding & Identity", 24, 7, 8, 9],
  ["HOME", "Learner Home / Dashboard & Discovery", 22, 16, 5, 1],
  ...
  ["REVIEW", "Review / FSRS, Confidence & Calibration", 24, 17, 6, 1],
  ["GAP", "Gap Map & Misconception Tracking", 23, 15, 6, 2],
  ["TEST", "Tests, Certificates & Verification", 23, 7, 13, 3],
