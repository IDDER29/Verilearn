...
export const metadata = { title: "New Topic · VeriLearn" };
          ...
          <div style={{ background: "#fff", borderRadius: 24, padding: "28px 30px", boxShadow: "0 10px 30px -18px rgba(80,60,140,.28)", display: "flex", flexDirection: "column", gap: 22 }}>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 10 }}>
                <div style={{ width: 30, height: 30, borderRadius: 10, background: "#efe9ff", display: "flex", alignItems: "center", justifyContent: "center", font: "900 13px var(--font-nunito)", color: "#6d5bd0" }}>1</div>
                <span style={{ font: "800 15px var(--font-nunito)" }}>The topic</span>
              </div>
              <input
                type="text"
                defaultValue="Merkle trees"
                style={{
                  width: "100%",
              ...
              <div style={{ display: "flex", gap: 7, flexWrap: "wrap", marginTop: 10 }}>
                ...
                <span style={{ font: "700 11.5px var(--font-nunito)", color: "#6d5bd0", background: "#f1eefb", padding: "4px 11px", borderRadius: 9 }}>TCP/IP</span>
                <span style={{ font: "700 11.5px var(--font-nunito)", color: "#6d5bd0", background: "#f1eefb", padding: "4px 11px", borderRadius: 9 }}>Binary trees</span>
                <span style={{ font: "700 11.5px var(--font-nunito)", color: "#6d5bd0", background: "#f1eefb", padding: "4px 11px", borderRadius: 9 }}>Bloom filters</span>
              </div>
            </div>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 6 }}>
                <div style={{ width: 30, height: 30, borderRadius: 10, background: "#efe9ff", display: "flex", alignItems: "center", justifyContent: "center", font: "900 13px var(--font-nunito)", color: "#6d5bd0" }}>2</div>
              ...
              <textarea
                rows={3}
                defaultValue="Comfortable with hashing; new to tree structures and cryptographic proofs."
                style={{
                  width: "100%",
                  boxSizing: "border-box",
                  font: "600 14.5px/1.6 var(--font-nunito)",
                  padding: "13px 15px",
                  border: "1.5px solid #ece8f4",
                  borderRadius: 13,
                  background: "#fbfafd",
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 12 }}>
                <div style={{ width: 30, height: 30, borderRadius: 10, background: "#efe9ff", display: "flex", alignItems: "center", justifyContent: "center", font: "900 13px var(--font-nunito)", color: "#6d5bd0" }}>3</div>
                <span style={{ font: "800 15px var(--font-nunito)" }}>Your goal</span>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "14px 16px", border: "2px solid #6d5bd0", background: "#f7f5fd", borderRadius: 14 }}>
                  ...
                  <span style={{ font: "800 13.5px var(--font-nunito)" }}>Understand the intuition</span>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "14px 16px", border: "2px solid #ece8f4", background: "#fff", borderRadius: 14 }}>
                  <div style={{ width: 34, height: 34, borderRadius: 11, background: "#f7f5fb", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#8b8699" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M8 6l-5 6 5 6M16 6l5 6-5 6" />
                    </svg>
                  </div>
                  <span style={{ font: "800 13.5px var(--font-nunito)", color: "#4a4560" }}>Implement it from scratch</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "14px 16px", border: "2px solid #ece8f4", background: "#fff", borderRadius: 14 }}>
                  <div style={{ width: 34, height: 34, borderRadius: 11, background: "#f7f5fb", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#8b8699" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span style={{ font: "800 13.5px var(--font-nunito)", color: "#4a4560" }}>Use it in practice</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "14px 16px", border: "2px solid #ece8f4", background: "#fff", borderRadius: 14 }}>
                  <div style={{ width: 34, height: 34, borderRadius: 11, background: "#f7f5fb", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#8b8699" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M7 10a5 5 0 0010 0V4H7zM5 4h14M9 20h6M12 15v5" />
                    </svg>
                  </div>
                  <span style={{ font: "800 13.5px var(--font-nunito)", color: "#4a4560" }}>Pass an interview</span>
                </div>
              </div>
            </div>
          ...
          <div style={{ background: "linear-gradient(160deg,#221d2e,#3a3550)", borderRadius: 24, padding: 24, color: "#fff", boxShadow: "0 16px 34px -16px rgba(40,30,70,.7)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 11, padding: "8px 0" }}>
                ...
                <span style={{ font: "700 13px var(--font-nunito)" }}>Triage the topic</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 11, padding: "8px 0" }}>
                <span style={{ width: 28, height: 28, borderRadius: 9, background: "rgba(255,255,255,.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#c4b8f5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span style={{ font: "700 13px var(--font-nunito)" }}>Retrieve trusted sources</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 11, padding: "8px 0" }}>
                <span style={{ width: 28, height: 28, borderRadius: 9, background: "rgba(255,255,255,.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#c4b8f5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span style={{ font: "700 13px var(--font-nunito)" }}>Write the lecture</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 11, padding: "8px 0" }}>
                <span style={{ width: 28, height: 28, borderRadius: 9, background: "rgba(255,255,255,.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#c4b8f5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span style={{ font: "700 13px var(--font-nunito)" }}>Verify each claim</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 11, padding: "8px 0" }}>
                <span style={{ width: 28, height: 28, borderRadius: 9, background: "rgba(255,255,255,.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#c4b8f5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span style={{ font: "700 13px var(--font-nunito)" }}>Skeptic red-teams it</span>
              </div>
            </div>
