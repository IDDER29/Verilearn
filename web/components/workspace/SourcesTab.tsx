      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 20, alignItems: "stretch" }}>
        ...
        <div style={{ background: "#221d2e", borderRadius: 24, padding: "24px 26px", color: "#fff", position: "relative", overflow: "hidden", display: "flex", alignItems: "center", gap: 22 }}>
          ...
          <button
            ...
            style={{ position: "relative", textDecoration: "none", display: "flex", alignItems: "center", gap: 7, background: "#fff", color: "#221f2e", font: "800 13.5px var(--font-nunito)", padding: "12px 20px", borderRadius: 13, whiteSpace: "nowrap", flexShrink: 0, border: "none", cursor: "pointer" }}
          >
